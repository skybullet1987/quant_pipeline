...
# 3. Production Simulation ($500.00 Starting Capital)
print("--> [3/4] Running pure production backtest ($500 starting equity)...")
...
taker_fee = 0.00035  # 3.5 bps taker fee
slippage = 0.00020   # 2.0 bps slippage
...
for t_idx, ts in enumerate(timestamps):
    ...
    # 2. Open New Setups (100% Cash during Chop/Ambiguity)
...
print("\n" + "="*55)
print("       PURE PRODUCTION STRATEGY BACKTEST (90D)")
print("="*55)
