...
print("--> [2/4] Estimating Causal HMM & BTC Trend Health...")
...
# 3. High-Alpha Walk-Forward Simulation
print("--> [3/4] Running Concentrated High-Alpha Compounding Simulation...")
...
# High-Alpha Optimized Parameters
MIN_HMM_BULL = 0.80       # Strict macro filter for longs
MIN_HMM_BEAR = 0.45       # Capitalize on active short edge
Q_LONG = 0.280            # Top-tier long confidence
Q_SHORT = 0.250           # Exploit validated short distribution
MAX_SLOTS = 2             # Concentrate capital (2 slots = 2.0x leverage per position)
PORTFOLIO_LEVERAGE = 4.0  # 4.0x gross exposure when both slots filled
MAX_HOLD_BARS = 18
COOLDOWN_BARS = 3
...
for t_idx, ts in enumerate(timestamps):
    ...
    # 2. Concentrated Position Entries
    ...
    if open_slots > 0:
        ...
        if p_bull >= MIN_HMM_BULL and btc_bull:
        ...
        # High-Conviction Shorts (Expanded 2.4x ATR TP)
...
print("\n" + "="*55)
print("     HIGH-ALPHA CONCENTRATED BACKTEST (90D)")
print("="*55)
