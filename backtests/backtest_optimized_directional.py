...
print("--> [2/4] Computing Causal HMM & BTC Macro Filters...")
...
# 3. Disciplined Production Simulation ($500.00 Capital)
print("--> [3/4] Running Optimized Simulation with BTC Trend Filter ($500 starting capital)...")
...
MIN_HMM_BULL = 0.70
MIN_HMM_BEAR = 0.45
Q_LONG = 0.280       # Filter long noise
Q_SHORT = 0.256      # Proven short edge
MAX_HOLD_BARS = 18
COOLDOWN_BARS = 4
MAX_SLOTS = 3
...
for t_idx, ts in enumerate(timestamps):
    ...
    # 2. Position Entries (Gated by Macro Trend)
    ...
    if open_slots > 0:
        ...
        # LONGS: Require Bull Regime + BTC Above 20 EMA + 24h Momentum Confirmation
        ...
        # SHORTS: Require Bear Regime + 24h Negative Momentum Confirmation
...
# 4. Analytics
print("--> [4/4] Generating Performance Analytics...")
...
print("\n" + "="*55)
print("     OPTIMIZED PRODUCTION STRATEGY BACKTEST (90D)")
print("="*55)
